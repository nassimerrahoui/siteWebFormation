...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 08 Mars 2017 à 22:00
...
INSERT INTO `formation` (`id_f`, `libelle`, `contenu`, `date_d`, `date_f`, `NbJour`, `id_p`, `id_a`) VALUES
(1, 'test1', 'blablabla', '2017-03-16', '2017-03-18', 2, 1, 1),
(2, 'test2', 'blablabla', '2017-04-06', '2017-04-08', 2, 2, 2),
(3, 'test3', 'blablabla', '2017-04-24', '2017-04-26', 2, 3, 3),
(4, 'test4', 'blablabla', '2017-04-27', '2017-05-02', 2, 4, 4),
(5, 'test5', 'blablabla', '2017-05-25', '2017-05-31', 2, 5, 5),
(6, 'ESport', 'ESport', '2017-04-07', '2017-04-11', 14, 2, 27),
(7, 'AllSport', 'AllSport', '2017-03-16', '2017-03-21', 5, 2, 28),
(8, 'Super', 'Super', '2017-03-11', '2017-03-13', 2, 3, 29),
(9, 'tennis', 'initiation', '2017-04-14', '2017-04-16', 2, 2, 30);
...
(3, 'user', 'user', 'user@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, 3, 2),
...
(7, 'user', 'user', 'user2@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(8, 'user', 'user', 'user3@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(9, 'user', 'user', 'user4@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(10, 'user', 'user', 'user5@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(11, 'user', 'user', 'user6@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(12, 'user', 'user', 'user7@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(13, 'user', 'user', 'user8@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(14, 'user', 'user', 'user9@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(15, 'user', 'user', 'user10@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(16, 'admin', 'admin', 'admin4@admin.fr', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 1, NULL, NULL),
(17, 'chef', 'chef', 'chef3@chef.fr', 'd5f2e5c77054c44c2c72a1b017deca06fc637c99', 1, 2, NULL, NULL),
(18, 'chef', 'chef', 'chef4@chef.fr', 'd5f2e5c77054c44c2c72a1b017deca06fc637c99', 1, 2, NULL, NULL),
(19, 'chef', 'chef', 'chef5@chef.fr', 'd5f2e5c77054c44c2c72a1b017deca06fc637c99', 1, 2, NULL, NULL),
(20, 'chef', 'chef', 'chef6@chef.fr', 'd5f2e5c77054c44c2c72a1b017deca06fc637c99', 1, 2, NULL, NULL),
(21, 'user', 'user', 'user11@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL),
(22, 'user', 'user', 'user12@user.fr', '12dea96fec20593566ab75692c9949596833adc9', 1, 3, NULL, NULL);
...
--
ALTER TABLE `adresse`
  MODIFY `id_a` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
--
